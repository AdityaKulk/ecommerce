...
<center>
      ...
      ?>
        ...
        <input style="width: 25%; height: 10%; border-radius: 5px;" type="password" placeholder="Enter your password" name="password" required />
            ...
            <br>
            <br>
            <a id="signup" href="register.php" >Do not have an account? Click here to sign up!</a>
            <br>
            <br>
            <br>
            <a id="signup" href="admin_login.php" >If You Have ADMIN Privelages you can login through here</a>
