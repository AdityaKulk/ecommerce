...
$query = $DBcon->query("SELECT * FROM Customer WHERE cid=".$_SESSION['userSession']);
...
<div class="navBar">
    ...
    <ul>
        ...
        <li class="dropdown">
          ...
          <li class="dropdown">
              <a href="appliances" class="dropbtn">Appliances</a>
              <div class="dropdown-content">
                  <div class="imgnav">
                      <a href="#">TV's</a>
                      <div class="imgnav-content">
            ...
            <li class="dropdown">
              ...
              <li class="dropdown">
                ...
                <li class="dropdown">
                  <a  class="dropbtn"><div style="color:white;"><span></span>&nbsp;Hi <?php echo $userRow['userName']; ?>....&nbsp;<span></span></div></a>
                  <div class="dropdown-content">
    
                  <div class="imgnav">
                  <h2 ><a id="logout" href="logout.php?logout"><span></span>&nbsp;Log Out</a></h2>
